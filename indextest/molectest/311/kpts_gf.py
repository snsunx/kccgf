    ...
    if p < nocc:
        ...
        for kc in range(nkpts):
            for kl in range(nkpts):
                ...
                print 'lpc, ', cc.kpts[kconserv[kl,kp,kc]]
                print 'clp, ', cc.kpts[kconserv[kc,kl,kp]]
                print 'lcp, ', cc.kpts[kconserv[kl,kc,kp]]
                print 'pcl, ', cc.kpts[kconserv[kp,kc,kl]]
                print 'cpl, ', cc.kpts[kconserv[kc,kp,kl]]
